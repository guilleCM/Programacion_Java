...
//Permite leer informacion de teclado, ficheros, etc... siempre lee Strings (numeros en string)
import java.io.IOException;
//Clase de entrada y salida
import java.io.InputStreamReader;
//Padre de BufferedReader
...
public class Principal {
    ...
    //sysdate ==> fecha de nuestro ordenador
    ...
    static ArrayList <Persona> listaProfesores; //CREAMOS OBJETO DEL TIPO ARRAYLIST PARA PROFESORES
